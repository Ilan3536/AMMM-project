...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{./documentation/assets/timeChart.pdf}
    \caption{Time chart}
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{./documentation/assets/objectiveChart.pdf}
    \caption{Objective chart}
    \label{fig:objective_chart}
\end{figure}
